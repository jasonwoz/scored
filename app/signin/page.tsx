...
export default function SignInPage() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If input doesn't contain @, treat it as username and find the corresponding email
  ...
  const handleGoogleSignIn = async () => {
    try {
      const { data, error } = await authClient.signIn.social({
        provider: "google",
        // Better Auth will handle the redirect automatically after OAuth completion
      });
